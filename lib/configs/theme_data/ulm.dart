...
class Ulm {
  ///Singleton factory
  static final Ulm _instance = Ulm._internal();
    ...
    switch (type) {
      case 'LIGHT':
        return ThemeData(
          ...
          indicatorColor: Color(0xffff9f43),
          ...
          chipTheme: ChipThemeData(
            ...
            brightness: Brightness.light,
            deleteIconColor: Color(0xffff9f43),
      ...
      default:
        return ThemeData(
          ...
          textSelectionColor: Color(0xffff9f43),
          cursorColor: Color(0xff4285f4),
          textSelectionHandleColor: Color(0xffff9f43),
