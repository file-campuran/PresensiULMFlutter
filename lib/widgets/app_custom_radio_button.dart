...
class AppCustomRadioButton extends StatefulWidget {
  AppCustomRadioButton({
    this.buttonLables,
    this.buttonValues,
    this.fontSize = 15,
    this.autoWidth = true,
  ...
  _AppCustomRadioButtonState createState() => _AppCustomRadioButtonState();
}

class _AppCustomRadioButtonState extends State<AppCustomRadioButton> {
